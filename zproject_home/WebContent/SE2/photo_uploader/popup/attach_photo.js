	...
	function checkDragAndDropAPI(){
		try{
			if( !oNavigator.ie ){
				if(!!oNavigator.safari && oNavigator.version <= 5){//사파리나 네비게이터 5버전 미만이면
    ...
    function html5Upload() {	
    	...
    	sUploadURL= 'zproject_home/SE2/photo_uploader/popup/file_uploader.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/zproject_home/SE2/photo_uploader/popup/file_uploader.jsp',	//샘플 URL입니다. .do .any
 			//sUrl  : '/file_uploader.do',	//샘플 URL입니다.
 	        sCallback : '/zproject_home/SE2/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
