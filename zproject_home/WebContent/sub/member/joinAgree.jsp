<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
   	...
   	<script src="<%=application.getContextPath() %>/js/member/joinAgree.js"></script>
   <link rel="stylesheet" href="<%=application.getContextPath()%>/css/member/joinAgree.css">
   	...
   	<section>
		...
		<div id="middle">
					<div id="middleHeader">
						...
						<div id="middleHeader_right">
							<ol class="join_txt">
							<li>
							<img src="<%=application.getContextPath() %>/img/member/join/txt_join_step01_on.gif">
							</li>
							<li>
		...
		<hr style="border: solid 2px black;">
				<div id="agree_form">	
					<div class="agree_box">
					<h3>
					<img src="<%=application.getContextPath() %>/img/member/join/stit_terms.gif">
					</h3>
						<legend>약관동의</legend>		
						<div class="box1">
						...
						<dl>
							<dt>제 1조 (목적)</dt>
							<dd>
								이 약관은 프리마켓(이하 "회사") 가 운영하는 인터넷 사이트를 통하여 제공하는 전자상거래 관련 서비스(이하 "서비스")를 이용함에 있어 회사와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. * PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.
							</dd>
						</dl>
						<dl>
							<dt>제 2조 (정의)</dt>
							<dd>
								<ol>
									<li>1. "회사"란 프리마켓주식회사가 재화 또는 용역(이하 "재화 등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신 설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버 몰을 운영하는 사업자의 의미로도 사용합니다.</li>
						...
						<dl>
							...
							<dd>
								<ol>
									<li>1. 프리마켓 Gift카드는 "회사"에서 발행한 무기명 선불카드로 일정 금액만큼 사용하실 수 있는 카드로 "회사"가 정한 소정의 방법에 의해 구매하실 수 있습니다. 지정하는 공식 판매처에서만 구매하실 수 있으며 이외의 곳에서 구매 하실 경우 어떠한 책임도 부담하지 않습니다.</li>
									<li>2. 온라인에서 물품이나 용역을 구매하기 위해서는 "회사"가 정한 방법에 따라 해당 Gift카드를 인터넷사용 등록해야 합니다.</li>
									<li>3. Gift카드 권면 금액이 1만원 초과일 경우 100분의 60 사용시, 1만원 이하일 경우 100분의 80 이상 사용시에는 프리마켓 온라인에서는 예치금으로 전환 받을 수 있으며 이 조건을 충족하지 못할 경우에는 잔액 환급이 되지 않습니다.</li>
					...
					<p class="tPad20">
						&nbsp;
						<input type="checkbox" id="agreeUse" name="ckbox" value="1" class="check">
						<label for="agreeUse">위의 <strong>'이용약관'</strong>에 동의 합니다.</label>
					</p>
				...
				<div class="agree_box">	
					<h3>
					<img src="<%=application.getContextPath() %>/img/member/join/stit_agree.gif">
					</h3>
						<legend>개인정보수집및이용동의</legend>
						<div class="box1">
						...
						<p>회사는 귀하께서 프리마켓의 개인정보취급방침 및 이용약관의 내용에 대해 「동의한다」버튼 또는 「동의하지 않는다」버튼을 클릭할 수 있는 절차를 마련하여, 「동의한다」버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 봅니다. 「동의안함」을 선택하실 경우, 회사가 제공하는 기본서비스 제공이 제한됩니다.</p>
						...
						<p class="tPad20">
						<input type="checkbox" id="agreePrivate" name="ckbox" value="1" class="check">
						<label for="agreeUse">위의 <strong>‘개인정보 보호를 위한 이용자 동의사항‘</strong>에 동의 합니다.</label>
						</p>
						
						<div class="all_agree tBar2">
						<hr style="border: solid 1px black;">
						<input type="checkbox" id="all_check" value="1" class="check">
						<label for="all_check"><strong>이용약관, 개인정보 수집 및 이용에 모두 동의합니다.</strong></label>
						</div>
					...
					<div id="agree_btn">
					<span class="btn btnM1 btnRed btnW130" id="agreeCheck">약관동의</span>
					<a href="<%=application.getContextPath() %>/index.jsp" class="btn btnM1 btnGry2 btnW130">취소</a>
					</div>
