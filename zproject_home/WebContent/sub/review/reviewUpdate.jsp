...
<body>
	<div id="reviewMenu">
		...
		<div id="reviewInfo">
			<a class="all" href="<%=application.getContextPath()%>/sub/review/reviewList.rw?curPage=1">전체리뷰</a> > 리뷰수정
		</div>
	</div>
	<form action="./reviewUpdate.rw" method="post" id="frm">
	<div id="writeDiv">
		<table>
			<tr>
				<td>제  목 </td>
				<td >
					<input type="text" name="title" id="title" value="${rdto.title }">
				</td>
			</tr>
			<tr>
			  	<td>내  용 </td>
			  	<td>
			  		<textarea name="smarteditor" id="smarteditor" rows="10" cols="100" style="width:100%; height:412px;">${rdto.contents}</textarea>
			  		<input type="hidden" value="${rdto.num}" name="num" >
			  	</td>
			</tr>
			<tr>
				<td colspan="2">
					<input type="button" class="sub" value="수정하기" id="savebutton">
