 ...
 <div id="middle">
	...
	<div id="menu_top">
 	...
 	<div id="middle_content">
		...
		<p>
		<img src="<%=application.getContextPath()%>/img/member/myPage/tit_myPage_parti.png">
		</p>
		<br>
		<a href="#">HOME</a> > <a href="#">MY FREEMARKET</a> > <a href="#">참여상품조회</a>
		<br><br>
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane" id="ing">
    	...
    	<c:if test="${list2 eq null}">
    		<tr>
			<td colspan="5">진행중인 참여상품이 없습니다.</td>
			</tr>
			</table>
    	</c:if>
    ...
    <div role="tabpanel" class="tab-pane" id="end">
		...
		<c:if test="${list3 eq null}">
			<tr>
			<td colspan="6">종료된 참여상품이 없습니다.</td>
			</tr>
			</table>
		</c:if>				
